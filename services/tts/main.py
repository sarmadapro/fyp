...
@app.get("/health")
async def health():
    return {"status": "healthy", "service": "tts", "voice": TTS_VOICE, "ready": _pipeline is not None}
...
async def synthesize(request: SynthesizeRequest):
    ...
    try:
        def run_synthesis():
            ...
            return wav_buffer.getvalue(), full_audio, start_time

        wav_bytes, full_audio, start_time = await asyncio.to_thread(run_synthesis)
        ...
        logger.error(f"Synthesis ValueError: {ve}")
